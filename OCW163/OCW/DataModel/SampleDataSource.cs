...
namespace OCW.Data
{
    ...
    public abstract class SampleDataCommon : OCW.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        { 
            ...
            var _sampleDataSourseInResourse = App.Current.Resources["sampleDataSourse"] as SampleDataSource;
            var matches = _sampleDataSourseInResourse.AllGroups.Where((group) => group.UniqueId.Equals(uniqueId));
            if (matches.Count() == 1) return matches.First();
            return null;
        }
        ...
        /// <returns></returns>
        public static SampleDataGroup GetCourseItems(string uniqueId)
        {
            //从Resourse中获取资源
            var _sampleDataSourseInResourse = App.Current.Resources["sampleDataSourse"] as SampleDataSource;
            //用uniqueId来判断课程
            var matches = _sampleDataSourseInResourse.CourseTypes.Where(ct=>ct.UniqueId.Equals(uniqueId));//.SelectMany(c=>c.Items).Where(item=>item.UniqueId.Equals(uniqueId));
            //var matches = _sampleDataSourseInResourse.CourseTypes.SelectMany(group => group.Items).Where((item) => item.UniqueId.Equals(uniqueId));
            if (matches.Count() == 1) return matches.First();
            return null;
        }
        
        // private static SampleDataGroup GetCourseSet(string uniqueId)
        //{
        //     //获取到匹配CourseType的uniqueId的NewCourseSet
        //    var _sampleDataSourseInResourse = App.Current.Resources["sampleDataSourse"] as SampleDataSource;
        //    var mathches = all.NewCourseSet.Where((ncs) => ncs.CourseType.ID.ToString().Equals(uniqueId));
        //    int count = mathches.Count();
        //    var temp = mathches.First().CourseType;
        //    SampleDataGroup sdg = new SampleDataGroup(uniqueId, 
        //        temp.Title,
        //        temp.Catalogue.Title,
        //        "Assets/earth.png",
        //        "这是描述");
        ...
        //        {
        //            sdg.Items.Add(new SampleDataItem("",
        //                m.CourseTitle,
        //                m.CourseType.Title,
        //                m.CourseImgUrl,
        //                m.CourseHrefUrl,
        ...
        //private ObservableCollection<SampleDataItem> _courseTypeItems = new ObservableCollection<SampleDataItem>();
        ///// <summary>
        ///// 课程类型的所有子课程
        ///// </summary>
        //public ObservableCollection<SampleDataItem> CourseTypeItems
        //{
        //    get { return this._courseTypeItems; }
        //}
        private ObservableCollection<SampleDataGroup> _courseTypes = new ObservableCollection<SampleDataGroup>();
        /// <summary>
        /// 课程类型的所有子课程
        /// </summary>
        public ObservableCollection<SampleDataGroup> CourseTypes
        {
            get { return this._courseTypes; }
        }
